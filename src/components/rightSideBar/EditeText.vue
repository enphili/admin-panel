<template>
  ...
  <ul class="icon-wrapper">
    <li>
      <button class="icon-btn">
        <svg class="icon-svg" width="17.000000" height="17.000000" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="icon-wrapper">
    <li>
      <button class="icon-btn">
        <svg class="icon-svg" width="14.571289" height="17.000000" viewBox="0 0 14.5713 17" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <li>
      <button class="icon-btn">
        <svg class="icon-svg" width="19.424805" height="17.000000" viewBox="0 0 19.4248 17" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
const selectedColor = ref('#FFFFFF') // Начальный цвет
const selectedBGColor = ref('#FFFFFF') // Начальный цвет
...
.select-color:focus-within {
  outline: none;
}
.insert-link {
  padding-left: 25px;
  background: url("/image/link.svg") no-repeat 7px center;
}
</style>